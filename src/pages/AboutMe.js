        ...
        <div>
          <section id="about">
            ...
            <p className="summary">
              ...
              and efficiency, but also creativity and problem-solving skills to
              any task at hand. I look forward to the opportunity to apply my
              skill-set to help bring your software development projects to
              life!
            </p>
          </section>
        </div>
